...
if __name__ == '__main__':
    ...
    texture_info = daerender.getTextureId('earth2_jpg')
    ...
    vreceiver = video.Receiver(texture_info, 
                               pipeline, 
                               sensor_cb.needdata,
                               pid_controller.target_callback)
    example = pid.Example()
    example.setup(pid_controller, sensor_cb.get_chassis_actuators())
    example.start()
